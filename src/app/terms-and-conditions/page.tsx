...
const TNC_DATA = [
    {
      ...
      description: `These Terms and Conditions ("Terms") govern your use of StrodaClub's website and services, including online mentor sessions and subscriptions, owned and operated by Vvkaey Edtech Private Limited, having its registered office at 139, Unit 101, Oxford Tower, HAL Old Airport Road, Kodihalli, Bangalore, Karnataka 560008. By accessing or using our services, you agree to comply with these Terms.`,
    },
    {
